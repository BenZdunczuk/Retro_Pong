...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        buttonPause->setGeometry(QRect(10, 20, 111, 81));
        gameWidget = new QWidget(centralwidget);
        gameWidget->setObjectName("gameWidget");
        gameWidget->setGeometry(QRect(50, 130, 801, 441));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        buttonPause->setText(QCoreApplication::translate("MainWindow", "Pauza", nullptr));
    } // retranslateUi
